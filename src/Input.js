    ...
    render() {
        ...
        return (
            <div className={this.props.className} style={wrapperStyle}>
                ...
                <div ref={sizerRef} style={sizerStyle} dangerouslySetInnerHTML={{ __html: escapedValue }}></div>
                {this.props.placeholder ?
                    <div ref={placeholderRef} style={sizerStyle}>{this.props.placeholder}</div> : null}
            </div>
        );
    }
}
